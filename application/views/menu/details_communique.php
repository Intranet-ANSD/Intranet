...
?>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                         ...
                         <?php if ($this->auth_user->is_connected && $this->session->auth_user['profil_nom'] == 'celcom') : ?>
                          <?= anchor(['celcom', 'edition', $this->communique->id], "Modifier") ?>
                         <?php endif; ?>
                        </ol>
                        </div>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class>
                <img src="<?php echo base_url('uploads/thumbnail/'.$this->communique->image);?>" class="img-fluid" >
                        <div class="panel-wrapper collapse in">
                            ...
                            <div class="panel-body">
                                    ...
                                    <?= $this->communique->author ?>

    </small>           
                                     </p>
                        <p>
                        <?= nl2br(htmlentities($this->communique->content)); ?> 
                        </p>
                                  
                                
                            </div>
                                <div class="panel-footer">   <?= $this->communique->date; ?> </div>
                        </div>
                    </div>
